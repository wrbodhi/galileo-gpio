...
/*
 * Microkernel version of the GPIO demo runs an endless loop blinking the
 * on-board LED (D13).  It also monitors a switch connected to connector pin D3,
 * turning on or off an LED attached to D4 to indicate the value of the switch.
 *
 */
 ...
 * - pin 4 is set as a GPIO output; and
 * - pin 13 is set as a GPIO output.
 *
...
static struct pin_config mux_config[NUM_IO_PINS_USED] = {
    ...
    { 4,  PINMUX_FUNC_A }, /* GPIO_SUS4 (out), GPIO_SUS4 (in), NA, NA */
